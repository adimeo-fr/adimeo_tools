 ...
 *   id = "genially_tac_service",
 *   label = "Genially Iframe",
 *   weight = 5
 * )
 */
class GeniallyTacService implements TacServiceInterface {

  /**
   * Constant which stores the plugin ID.
   */
  const PLUGIN_ID = 'genially_tac_service';

  /**
   * Constant which stores the library name.
   */
  const LIBRARY_NAME = 'tac_services/tac_genially';
