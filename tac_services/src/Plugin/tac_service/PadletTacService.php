 ...
 *   id = "padlet_tac_service",
 *   label = "Padlet Iframe",
 *   weight = 5
 * )
 */
class PadletTacService implements TacServiceInterface {

  /**
   * Constant which stores the plugin ID.
   */
  const PLUGIN_ID = 'padlet_tac_service';

  /**
   * Constant which stores the library name.
   */
  const LIBRARY_NAME = 'tac_services/tac_padlet';
