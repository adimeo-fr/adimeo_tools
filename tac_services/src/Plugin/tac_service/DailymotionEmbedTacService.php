 ...
 *   id = "dailymotion_embed_tac_service",
 *   label = "Dailymotion Embed",
 *   weight = 5
 * )
 */
class DailymotionEmbedTacService implements TacServiceInterface {


  /**
   * Constant which stores the plugin ID.
   */
  const PLUGIN_ID = 'dailymotion_embed_tac_service';

  /**
   * Constant which stores the library name.
   */
  const LIBRARY_NAME = 'tac_services/tac_dailymotion_embed';
